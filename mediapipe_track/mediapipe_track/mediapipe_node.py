...
class MediaPipeNode(Node, MediaPipePose):
    ...
    def pose_action_callback(self, goal_handle):
        ...
        self.get_logger().info(str(type(goal)))
        ...
        pose_landmarks, skeleton_img, target_point = self.preprocess_and_predict(img_msg, draw=goal.get_drawn.data, torso_point=goal.get_torso_point.data)
    ...
    def preprocess_and_predict(self, img_msg, draw=False, torso_point=False):
        ...
        if img_msg.height > 0 and img_msg.width > 0:
            ...
            if torso_point and pose_landmarks_list:
                ...
                self.msg_target_point.point.x = x
                self.msg_target_point.point.y = y
                self.msg_target_point.point.z = z
